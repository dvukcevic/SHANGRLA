...
for (i, orderdata_i) in enumerate(orderdata):
    ...
    current_contest.assertions.set_p_values(cvr_list_shuffled, use_all=True)
...
outfile1 = "output/exp1-" + datafile + "-raire-bp-summary1.csv"
outfile2 = "output/exp1-" + datafile + "-raire-bp-pvalues1.csv"
